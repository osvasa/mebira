                  ...
                  <div key={c.id} className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
                    <div className="p-4 flex items-center gap-4">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-violet-500 text-white rounded-lg text-xs font-semibold hover:bg-violet-600 transition-colors flex-shrink-0"
                      >
                            ...
                            {(creatorPosts[c.id] ?? []).map((p) => (
                              <div key={p.id} className="flex items-center gap-3 bg-white rounded-lg px-3 py-2 border border-slate-100">
                                ...
                                <button
                                  ...
                                  className="flex items-center gap-1 px-2 py-1 text-xs text-sky-500 hover:text-sky-700 hover:bg-sky-50 rounded-lg transition-colors"
                                >
                                  <PenLine className="w-3 h-3" />
                                  Edit
                                </button>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-4 mb-4 space-y-3 shadow-sm">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 py-2 bg-violet-500 text-white rounded-xl text-sm font-semibold hover:bg-violet-600 disabled:opacity-50 flex items-center justify-center gap-1.5"
                  >
